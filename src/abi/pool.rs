...
pub mod functions {
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for BridgeProtocolFee {
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for BackUnbacked {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(&[
                ...
                ethabi::Token::Tuple(vec![
                    ...
                    ethabi::Token::Address(ethabi::Address::from_slice(&self.category.3)),
                    ethabi::Token::String(self.category.4.clone()),
                ]),
            ]);
            let mut encoded = Vec::with_capacity(4 + data.len());
            encoded.extend(Self::METHOD_ID);
    ...
    impl InitReserve {
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(&[
                ...
                ethabi::Token::Address(ethabi::Address::from_slice(&self.stable_debt_address)),
    ...
    impl SetReserveInterestRateStrategyAddress {
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(&[
                ethabi::Token::Address(ethabi::Address::from_slice(&self.asset)),
                ethabi::Token::Address(ethabi::Address::from_slice(&self.rate_strategy_address)),
            ]);
            let mut encoded = Vec::with_capacity(4 + data.len());
            encoded.extend(Self::METHOD_ID);
            encoded.extend(data);
    ...
    impl UpdateFlashloanPremiums {
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(&[
                ...
                ethabi::Token::Uint(ethabi::Uint::from_big_endian(
                    match self.flash_loan_premium_to_protocol.clone().to_bytes_be() {
                        (num_bigint::Sign::Plus, bytes) => bytes,
                        (num_bigint::Sign::NoSign, bytes) => bytes,
                        (num_bigint::Sign::Minus, _) => {
                            panic!("negative numbers are not supported")
...
pub mod events {
    ...
    impl BackUnbacked {
        const TOPIC_ID: [u8; 32] = [
            40u8, 21u8, 150u8, 233u8, 43u8, 45u8, 151u8, 75u8, 235u8, 125u8, 79u8, 18u8, 77u8,
            243u8, 10u8, 11u8, 57u8, 6u8, 123u8, 9u8, 104u8, 147u8, 233u8, 80u8, 17u8, 206u8, 75u8,
            218u8, 215u8, 152u8, 183u8, 89u8,
        ];
        ...
        pub fn decode(log: &substreams_ethereum::pb::eth::v2::Log) -> Result<Self, String> {
            ...
            Ok(Self {
                reserve: ethabi::decode(&[ethabi::ParamType::Address], log.topics[1usize].as_ref())
                    ...
                    .as_bytes()
                    .to_vec(),
                backer: ethabi::decode(&[ethabi::ParamType::Address], log.topics[2usize].as_ref())
                    .map_err(|e| {
                        format!(
    ...
    impl MintUnbacked {
        const TOPIC_ID: [u8; 32] = [
            242u8, 90u8, 243u8, 123u8, 61u8, 62u8, 194u8, 38u8, 6u8, 61u8, 201u8, 189u8, 193u8,
            3u8, 236u8, 231u8, 235u8, 17u8, 10u8, 80u8, 243u8, 64u8, 254u8, 133u8, 75u8, 183u8,
            188u8, 27u8, 6u8, 118u8, 215u8, 208u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 4usize {
                return false;
    ...
    impl RebalanceStableBorrowRate {
        const TOPIC_ID: [u8; 32] = [
            159u8, 67u8, 154u8, 224u8, 200u8, 30u8, 65u8, 160u8, 77u8, 63u8, 223u8, 224u8, 122u8,
            237u8, 84u8, 230u8, 161u8, 121u8, 251u8, 13u8, 177u8, 91u8, 231u8, 112u8, 46u8, 182u8,
            111u8, 168u8, 239u8, 111u8, 83u8, 0u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 3usize {
                return false;
    ...
    impl SwapBorrowRateMode {
        const TOPIC_ID: [u8; 32] = [
            121u8, 98u8, 179u8, 148u8, 216u8, 90u8, 83u8, 64u8, 51u8, 186u8, 46u8, 252u8, 244u8,
            60u8, 211u8, 109u8, 229u8, 123u8, 126u8, 190u8, 179u8, 222u8, 12u8, 164u8, 66u8, 137u8,
            101u8, 217u8, 179u8, 221u8, 196u8, 129u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 3usize {
                return false;
